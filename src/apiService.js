...
const apiClient = axios.create({
    baseURL: import.meta.env.VITE_API_BASE_URL, // Your .NET server URL
    headers: {
...
export const apiGetEmployees = () => {
    // Yeh line hamesha ek unique URL banayegi, jisse browser purana data nahi dikhayega
    const cacheBuster = `_t=${new Date().getTime()}`;
    return apiClient.get(`/Employees?${cacheBuster}`);
};
export const apiGetEmployeeNames = () => apiClient.get('/Employees/all-names');
