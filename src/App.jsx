...
// --- NAYE IMPORTS ---
import LandingPage from './components/Landing/LandingPage'; // <-- NAYA LANDING PAGE
...
const MainLayout = () => {
    ...
    const getTitleFromPath = (path) => {
        ...
        if (path.startsWith('/helpdesk/')) return 'Ticket Details'; // <-- YEH LINE ADD KI GAYI
    ...
    return (
        <>
            ...
            <Routes>
                ...
                {/* --- SUPER ADMIN ROUTE (No sidebar/header) --- */}
                <Route path="/super-admin" element={
                    user ? (user.role === 'super_admin' ? <SuperAdminDashboard /> : <Navigate to="/dashboard" />)
                         : <Navigate to="/login" />
                } />
                ...
                {/* --- Wildcard Catch-all (Agar user logged in hai toh dashboard, warna landing page) --- */}
